...
namespace MetalMock
{
   ...
   {
      ZENUNIT_EQUALIZER_TEST_SETUP(Call10);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, firstArgument, V1);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, secondArgument, V2);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, thirdArgument, V3);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, fourthArgument, V4);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, fifthArgument, V5);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, sixthArgument, V6);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, seventhArgument, V7);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, eigthArgument, V8);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, ninthArgument, V9);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call10, tenthArgument, V10);
   }
...
namespace MetalMock
{
   ...
   TEST(ZenUnitPrinterPrint_WritesToStringeredArgs)
   {
      ...
      const string expected = "MetalMock::TenArgumentFunctionCall:\n"
" Argument1: \"1\"\n"
" Argument2: \"2\"\n"
" Argument3: \"3\"\n"
" Argument4: \"4\"\n"
