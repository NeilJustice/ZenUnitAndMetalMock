...
namespace MetalMock
{
   ...
   public:
      ...
      void MetalMockedFunction_NotExpected_ThrowsUnexpectedCallException()
      {
         ...
         {
            const string expectedExceptionMessage = UnexpectedCallException::MakeExceptionMessage(expectedFunctionSignature, 0, 0, 0, 0);
            THROWS_EXCEPTION(metalMockFunctionCallLambda(),
               UnexpectedCallException, expectedExceptionMessage);
         };
         test([&] { _metalMockObject.VirtualFunction(0, 0, 0, 0); }, _virtualFunctionSignature);
         test([&] { _metalMockObject.VirtualFunctionConst(0, 0, 0, 0); }, _virtualFunctionConstSignature);
         test([&] { _metalMockObject.NonVirtualFunction(0, 0, 0, 0); }, _nonVirtualFunctionSignature);
         test([&] { _metalMockObject.NonVirtualFunctionConst(0, 0, 0, 0); }, _nonVirtualFunctionConstSignature);
         function<void(int, int, int, int)> metalMockBoundFreeFunction = BIND_4ARG_METALMOCK_OBJECT(_freeFunctionMockObject);
         test([&] { metalMockBoundFreeFunction(0, 0, 0, 0); }, _freeFunctionSignature);
         function<void(int, int, int, int)> metalMockBoundStaticFunction = BIND_4ARG_METALMOCK_OBJECT(_staticMockObject);
         test([&] { metalMockBoundStaticFunction(0, 0, 0, 0); }, _staticFunctionSignature);
      }
      ...
      void CalledNTimes_FunctionCalledNTimes_DoesNotThrowException()
      {
         ...
         const auto test = [&](auto& metalMockObject)
         {
            ...
            //
            MetalMockTestUtils::CallNTimes(actualNumberOfFunctionCalls, [&] { metalMockObject.MetalMockIt(0, 0, 0, 0); });
            //
...
"File.cpp(1)");
      ...
      void CalledWith_FunctionCalledOnlyOnce_ThrowsAnomaly()
      {
         const auto test = [](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            metalMockObject.p_wasExpected = true;
            //
            metalMockObject.MetalMockIt(10, 10, 10, 10);
            //
...
File.cpp(1))");
      ...
      void CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_Returns()
      {
         const auto test = [](auto& metalMockObject)
         {
            ...
            //
            metalMockObject.CalledWith(10, 10, 10, 10);
            metalMockObject.CalledWith(20, 20, 20, 20);
         };
         test(_metalMockObject.VirtualFunctionMock);
         test(_metalMockObject.VirtualFunctionConstMock);
         test(_metalMockObject.NonVirtualFunctionMock);
  ...
  Failed: ARE_EQUAL(expectedFourArgumentFunctionCall, nextActualFourArgumentFunctionCall, this->p_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
Expected: MetalMock::FourArgumentFunctionCall:
Argument1: 20
Argument2: 20
Argument3: 20
Argument4: 20
  Actual: MetalMock::FourArgumentFunctionCall:
Argument1: 10
Argument2: 10
Argument3: 10
Argument4: 10
 Because: ARE_EQUAL(expectedFourArgumentFunctionCall.arg1Reference.value, actualFourArgumentFunctionCall.arg1Reference.value) failed
Expected: 20
  Actual: 10
 Message: ")", expectedFunctionSignature, R"(", "_currentCalledWithAssertionIndex=0"
File.cpp(1)
File.cpp(1))");
            THROWS_EXCEPTION(metalMockObject.CalledWith(20, 20, 20, 20),
...
File.cpp(1))");
            metalMockObject.CalledWith(10, 10, 10, 10);
            THROWS_EXCEPTION(metalMockObject.CalledWith(30, 30, 30, 30),
               Anomaly, expectedExceptionMessage);
         };
         test(_metalMockObject.VirtualFunctionMock, _virtualFunctionSignature);
         test(_metalMockObject.VirtualFunctionConstMock, _virtualFunctionConstSignature);
...
File.cpp(1))");
      ...
      void CalledOnceWith_CalledTwice_ThrowsException()
      {
         const auto test = [](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            ...
            //
            metalMockObject.MetalMockIt(arg1, arg2, arg3, arg4);
            //
            metalMockObject.CalledOnceWith(arg1, arg2, arg3, arg4);
            ...
            THROWS_EXCEPTION(metalMockObject.CalledOnceWith(arg1, arg2, arg3, arg4),
