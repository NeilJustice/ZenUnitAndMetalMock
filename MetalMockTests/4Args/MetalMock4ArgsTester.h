...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedFourArgumentFunctionCall, nextActualFourArgumentFunctionCall, this->metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
