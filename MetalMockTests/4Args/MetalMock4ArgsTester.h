...
"File.cpp(1)");
  ...
  Failed: CONTAINS_ELEMENT(expectedFourArgumentFunctionCall, actualFourArgumentFunctionCalls, this->metalMockedFunctionSignature)
Expected: Collection contains element 'MetalMock::FourArgumentFunctionCall:
Argument1: 20
Argument2: 20
Argument3: 20
Argument4: 20'
...
File.cpp(1))");
      ...
      void CalledWith_CalledTwice_ThrowsException()
      {
         const auto test = [](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            ...
            //
            metalMockObject.CalledWith(arg1, arg2, arg3, arg4);
            ...
            THROWS_EXCEPTION(metalMockObject.CalledWith(arg1, arg2, arg3, arg4),
