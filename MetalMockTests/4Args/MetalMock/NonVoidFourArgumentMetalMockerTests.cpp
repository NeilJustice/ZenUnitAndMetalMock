...
namespace MetalMock
{
   ...
   {
      IS_FALSE(_nonVoidFourArgumentMetalMocker->p_wasExpected);
      ...
      IS_TRUE(_nonVoidFourArgumentMetalMocker->p_wasExpected);
   }
   ...
   TEST(MetalMockItAndReturnValue_CallInsteadPreviouslyCalled_CallsBaseMetalMockIt_ReturnsResultOfCallingCallInsteadFunctionOnce)
   {
      ...
      //
      const vector<tuple<int, int, int, int>> expectedCallInsteadFunctionArguments =
      {
         { arg1, arg2, arg3, arg4 }
      };
