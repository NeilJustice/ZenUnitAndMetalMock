...
namespace MetalMock
{
   ...
   {
      _metalMock5ArgsTester->CalledWith_FunctionCalledOnceWithMatchingArg_DoesNotThrowException();
   }
   ...
   {
      _metalMock5ArgsTester->CalledWith_FunctionCalledOnceWithMismatchingArg_ThrowsAnomaly();
   }
   ...
   {
      _metalMock5ArgsTester->CalledWith_CalledTwice_ThrowsException();
   }
   ...
   {
      _metalMock5ArgsTester->CalledAsFollows_CalledTwice_ThrowsException();
   }
