...
namespace MetalMock
{
   ...
   {
      _metalMock5ArgsTester->CalledWith_ExpectedFunctionCalledOnceWithMatchingArg_DoesNotThrowException();
   }

   TEST(CalledWith_ExpectedFunctionCalledTwiceWithMatchingArgAndOnceWithMistmatchingArg_DoesNotThrowException)
   {
      _metalMock5ArgsTester->CalledWith_ExpectedFunctionCalledTwiceWithMatchingArgAndOnceWithMistmatchingArg_DoesNotThrowException();
   }

   TEST(CalledWith_ExpectedFunctionCalledOnceWithMismatchingArg_ThrowsAnomaly)
   {
      _metalMock5ArgsTester->CalledWith_ExpectedFunctionCalledOnceWithMismatchingArg_ThrowsAnomaly();
   }
