...
namespace MetalMock
{
   ...
   METALMOCK_VOID5_STATIC_OR_FREE(_call_FreeVoid5ArgsFunction, int, int, int, int, int)
   METALMOCK_VOID5_STATIC_OR_FREE(_call_StaticVoid5ArgsFunction, int, int, int, int, int)
   ...
   {
      _metalMock5ArgsTester->CalledWith_FunctionCalledOnlyOnce_ThrowsAnomaly();
   }
   ...
   {
      _metalMock5ArgsTester->CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgDoesNotMatch_ThrowsAnomaly();
   }

   TEST(CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_CalledWithCalledThreeTimes_ThrowsAnomaly)
   {
      _metalMock5ArgsTester->CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_CalledWithCalledThreeTimes_ThrowsAnomaly();
   }
