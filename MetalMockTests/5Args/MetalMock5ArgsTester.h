...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedFiveArgumentFunctionCall, nextActualFiveArgumentFunctionCall, this->metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
