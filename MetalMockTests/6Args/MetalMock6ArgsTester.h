...
namespace MetalMock
{
   ...
   public:
      ...
      void MetalMockedFunction_NotExpected_ThrowsUnexpectedCallException()
      {
         ...
         {
            const string expectedExceptionMessage = UnexpectedCallException::MakeExceptionMessage(expectedFunctionSignature, 0, 0, 0, 0, 0, 0);
            THROWS_EXCEPTION(metalMockFunctionCallLambda(),
               UnexpectedCallException, expectedExceptionMessage);
         };
         test([&] { _metalMockObject.VirtualFunction(0, 0, 0, 0, 0, 0); }, _virtualFunctionSignature);
         test([&] { _metalMockObject.VirtualFunctionConst(0, 0, 0, 0, 0, 0); }, _virtualFunctionConstSignature);
         test([&] { _metalMockObject.NonVirtualFunction(0, 0, 0, 0, 0, 0); }, _nonVirtualFunctionSignature);
         test([&] { _metalMockObject.NonVirtualFunctionConst(0, 0, 0, 0, 0, 0); }, _nonVirtualFunctionConstSignature);
         function<void(int, int, int, int, int, int)> metalMockBoundFreeFunction = BIND_6ARG_METALMOCK_OBJECT(_freeFunctionMockObject);
         test([&] { metalMockBoundFreeFunction(0, 0, 0, 0, 0, 0); }, _freeFunctionSignature);
         function<void(int, int, int, int, int, int)> metalMockBoundStaticFunction = BIND_6ARG_METALMOCK_OBJECT(_staticMockObject);
         test([&] { metalMockBoundStaticFunction(0, 0, 0, 0, 0, 0); }, _staticFunctionSignature);
      }
      ...
      void CalledNTimes_FunctionCalledNTimes_DoesNotThrowException()
      {
         ...
         {
            metalMockObject.p_wasExpected = true;
            //
            MetalMockTestUtils::CallNTimes(actualNumberOfFunctionCalls, [&] { metalMockObject.MetalMockIt(0, 0, 0, 0, 0, 0); });
            //
...
"File.cpp(1)");
      ...
      void CalledWith_FunctionCalledOnlyOnce_ThrowsAnomaly()
      {
         const auto test = [](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            metalMockObject.p_wasExpected = true;
            //
            metalMockObject.MetalMockIt(10, 10, 10, 10, 10, 10);
            //
            THROWS_EXCEPTION(metalMockObject.CalledWith(10, 10, 10, 10, 10, 10),
               ZenUnit::Anomaly, R"(
  Failed: IS_GREATER_THAN_OR_EQUAL(p_metalMockedFunctionCallHistory.size(), 2ULL, this->p_metalMockedFunctionSignature)
Expected: 1
  Actual: 2
...
File.cpp(1))");
      ...
      void CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_Returns()
      {
         const auto test = [](auto& metalMockObject)
         {
            ...
            //
            metalMockObject.MetalMockIt(10, 10, 10, 10, 10, 10);
            metalMockObject.MetalMockIt(20, 20, 20, 20, 20, 20);
            //
            metalMockObject.CalledWith(10, 10, 10, 10, 10, 10);
            metalMockObject.CalledWith(20, 20, 20, 20, 20, 20);
         };
         test(_metalMockObject.VirtualFunctionMock);
         test(_metalMockObject.VirtualFunctionConstMock);
         test(_metalMockObject.NonVirtualFunctionMock);
  ...
  Failed: ARE_EQUAL(expectedSixArgumentFunctionCall, nextActualSixArgumentFunctionCall, this->p_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
Expected: MetalMock::SixArgumentFunctionCall:
Argument1: 20
Argument2: 20
Argument3: 20
Argument4: 20
Argument5: 20
Argument6: 20
  Actual: MetalMock::SixArgumentFunctionCall:
Argument1: 10
Argument2: 10
Argument3: 10
Argument4: 10
Argument5: 10
Argument6: 10
 Because: ARE_EQUAL(expectedSixArgumentFunctionCall.arg1Reference.value, actualSixArgumentFunctionCall.arg1Reference.value) failed
Expected: 20
  Actual: 10
 Message: ")", expectedFunctionSignature, R"(", "_currentCalledWithAssertionIndex=0"
File.cpp(1)
File.cpp(1))");
            THROWS_EXCEPTION(metalMockObject.CalledWith(20, 20, 20, 20, 20, 20),
...
File.cpp(1))");
            metalMockObject.CalledWith(10, 10, 10, 10, 10, 10);
            THROWS_EXCEPTION(metalMockObject.CalledWith(30, 30, 30, 30, 30, 30),
               Anomaly, expectedExceptionMessage);
         };
         test(_metalMockObject.VirtualFunctionMock, _virtualFunctionSignature);
         test(_metalMockObject.VirtualFunctionConstMock, _virtualFunctionConstSignature);
      ...
      void CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_CalledWithCalledThreeTimes_ThrowsAnomaly()
      {
         const auto test = [&](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            ...
            //
            const string expectedExceptionMessage = String::ConcatValues(R"(
  Failed: IS_LESS_THAN(_currentCalledWithAssertionIndex, p_metalMockedFunctionCallHistory.size(), this->p_metalMockedFunctionSignature)
Expected: 2
  Actual: 2
 Message: ")", expectedFunctionSignature, R"("
File.cpp(1))");
