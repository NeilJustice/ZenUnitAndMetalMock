...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedSixArgumentFunctionCall, nextActualSixArgumentFunctionCall, this->metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
