...
namespace MetalMock
{
   ...
   METALMOCK_VOID6_STATIC_OR_FREE(_call_FreeVoid6ArgsFunction, int, int, int, int, int, int)
   METALMOCK_VOID6_STATIC_OR_FREE(_call_StaticVoid6ArgsFunction, int, int, int, int, int, int)
   ...
   const string StaticFunctionSignature =
      "void _call_StaticVoid6ArgsFunction(int, int, int, int, int, int)";
   ...
   {
      _metalMock6ArgsTester->CalledWith_FunctionCalledOnlyOnce_ThrowsAnomaly();
   }

   TEST(CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_Returns)
   {
      _metalMock6ArgsTester->CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_Returns();
   }

   TEST(CalledWith_FunctionCalledTwice_SecondArgAssertedBeforeFirstArg_ThrowsAnomaly)
   {
      _metalMock6ArgsTester->CalledWith_FunctionCalledTwice_SecondArgAssertedBeforeFirstArg_ThrowsAnomaly();
   }

   TEST(CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgDoesNotMatch_ThrowsAnomaly)
   {
      _metalMock6ArgsTester->CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgDoesNotMatch_ThrowsAnomaly();
   }

   TEST(CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_CalledWithCalledThreeTimes_ThrowsAnomaly)
   {
      _metalMock6ArgsTester->CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_CalledWithCalledThreeTimes_ThrowsAnomaly();
   }
   ...
   {
      _metalMock6ArgsTester->CalledOnceWith_CalledTwice_ThrowsException();
   }
