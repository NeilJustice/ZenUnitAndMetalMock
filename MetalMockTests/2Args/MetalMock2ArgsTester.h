...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedTwoArgumentFunctionCall, nextActualTwoArgumentFunctionCall, this->p_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedArg1, p_metalMockedFunctionCallHistory[0].arg1.value, this->p_metalMockedFunctionSignature)
Expected: 20
  Actual: 10
 Message: ")", expectedFunctionSignature, R"("
File.cpp(1))");
...
File.cpp(1))");
      ...
      void CalledNTimesWith_NIs1OrGreater_FunctionWasCalledNTimesButNotWithExpectedArg_ThrowsAnomaly()
      {
         const auto test = [&](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            ...
            //
            const string expectedExceptionMessage = String::ConcatStrings(R"(
  Failed: ARE_EQUAL(expectedArg1, p_metalMockedFunctionCallHistory[i].arg1.value, metalMockedFunctionSignatureAndCallIndex)
Expected: 10
  Actual: 100
