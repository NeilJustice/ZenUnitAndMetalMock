...
File.cpp(1))");
  ...
  Failed: ARE_EQUAL(expectedThreeArgumentFunctionCall, nextActualThreeArgumentFunctionCall, this->_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
