...
"File.cpp(1)");
      ...
      void CalledWith_FunctionCalledOnlyOnce_ThrowsAnomaly()
      {
         const auto test = [](auto& metalMockObject, const string& expectedFunctionSignature)
         {
            ...
            //
            THROWS_EXCEPTION(metalMockObject.CalledWith(10, 10, 10),
               ZenUnit::Anomaly, R"(
...
File.cpp(1))");
      ...
      void CalledWith_FunctionCalledTwice_FirstArgMatches_SecondArgMatches_Returns()
      {
         const auto test = [](auto& metalMockObject)
         {
            ...
            metalMockObject.CalledWith(20, 20, 20);
         };
         test(_metalMockObject.VirtualFunctionMock);
         test(_metalMockObject.VirtualFunctionConstMock);
         test(_metalMockObject.NonVirtualFunctionMock);
  ...
  Failed: ARE_EQUAL(expectedThreeArgumentFunctionCall, nextActualThreeArgumentFunctionCall, this->p_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
Expected: MetalMock::ThreeArgumentFunctionCall:
Argument1: 20
Argument2: 20
Argument3: 20
  Actual: MetalMock::ThreeArgumentFunctionCall:
Argument1: 10
Argument2: 10
Argument3: 10
 Because: ARE_EQUAL(expectedThreeArgumentFunctionCall.arg1Reference.value, actualThreeArgumentFunctionCall.arg1Reference.value) failed
Expected: 20
  Actual: 10
...
File.cpp(1))");
            metalMockObject.CalledWith(10, 10, 10);
            THROWS_EXCEPTION(metalMockObject.CalledWith(30, 30, 30),
               Anomaly, expectedExceptionMessage);
         };
         test(_metalMockObject.VirtualFunctionMock, _virtualFunctionSignature);
         test(_metalMockObject.VirtualFunctionConstMock, _virtualFunctionConstSignature);
