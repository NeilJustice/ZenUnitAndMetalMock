...
namespace MetalMock
{
   ...
   using MetalMockerType = SevenArgumentMetalMocker<int, int, int, int, int, int, int, ExceptionThrowerMock>;
   ...
   TEST(MetalMockIt_ExpectedFalse_Throws)
   {
      ...
      THROWS_EXCEPTION(_metalMocker->MetalMockIt(1, 2, 3, 4, 5, 6, 7), UnexpectedCallException,
         UnexpectedCallException::MakeWhat(_metalMockedFunctionSignature, 1, 2, 3, 4, 5, 6, 7));
   }
