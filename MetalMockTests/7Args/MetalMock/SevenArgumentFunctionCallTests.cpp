...
namespace MetalMock
{
   ...
   TEST(DefaultConstructor_DefaultInitializesFields)
   {
      ...
      ARE_EQUAL(A7T::DV1, sevenArgumentFunctionCall.arg1.value);
      ARE_EQUAL(A7T::DV2, sevenArgumentFunctionCall.arg2.value);
      ARE_EQUAL(A7T::DV3, sevenArgumentFunctionCall.arg3.value);
      ARE_EQUAL(A7T::DV4, sevenArgumentFunctionCall.arg4.value);
      ARE_EQUAL(A7T::DV5, sevenArgumentFunctionCall.arg5.value);
      ARE_EQUAL(A7T::DV6, sevenArgumentFunctionCall.arg6.value);
      ARE_EQUAL(A7T::DV7, sevenArgumentFunctionCall.arg7.value);
   }
   ...
   TEST(Constructor_CopiesValuesToDecayTypeFields)
   {
      const SevenArgumentFunctionCall<const T<1>&, const T<2>&, const T<3>&, const T<4>&, const T<5>&, const T<6>&, const T<7>&>
         call(A7T::V1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      //
      ARE_COPIES(A7T::V1, call.arg1.value);
      ARE_COPIES(A7T::V2, call.arg2.value);
      ARE_COPIES(A7T::V3, call.arg3.value);
      ARE_COPIES(A7T::V4, call.arg4.value);
      ARE_COPIES(A7T::V5, call.arg5.value);
      ARE_COPIES(A7T::V6, call.arg6.value);
      ARE_COPIES(A7T::V7, call.arg7.value);
   ...
   TEST(ZenUnitEqualizer_CallsAreEqualOnEachField)
   {
      ...
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg1, A7T::V1);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg2, A7T::V2);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg3, A7T::V3);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg4, A7T::V4);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg5, A7T::V5);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg6, A7T::V6);
      ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Call7, arg7, A7T::V7);
   }
   ...
   {
      const CallRef7 callRef(A7T::V1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      //
      ARE_SAME(A7T::V1, callRef.arg1Reference.value);
      ARE_SAME(A7T::V2, callRef.arg2Reference.value);
      ARE_SAME(A7T::V3, callRef.arg3Reference.value);
      ARE_SAME(A7T::V4, callRef.arg4Reference.value);
      ARE_SAME(A7T::V5, callRef.arg5Reference.value);
      ARE_SAME(A7T::V6, callRef.arg6Reference.value);
      ARE_SAME(A7T::V7, callRef.arg7Reference.value);
   }

   TEST(CallConstructor_SetsReferencesToFiveArgumentFunctionCallArgs)
   {
      const Call7 call(A7T::V1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      //
...
"Argument7: \"7\"";
   ...
   TEST(ZenUnitEqualizer_ThrowsIfAnyFieldNotEqual)
   {
      ...
      const CallRef7 callRef_arg1(VF1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg1); }, "arg1");

      const CallRef7 callRef_arg2(A7T::V1, VF2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg2); }, "arg2");

      const CallRef7 callRef_arg3(A7T::V1, A7T::V2, VF3, A7T::V4, A7T::V5, A7T::V6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg3); }, "arg3");

      const CallRef7 callRef_arg4(A7T::V1, A7T::V2, A7T::V3, VF4, A7T::V5, A7T::V6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg4); }, "arg4");

      const CallRef7 callRef_arg5(A7T::V1, A7T::V2, A7T::V3, A7T::V4, VF5, A7T::V6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg5); }, "arg5");

      const CallRef7 callRef_arg6(A7T::V1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, VF6, A7T::V7);
      AssertARE_EQUALThrowsAnomalyContaining([&] { ARE_EQUAL(callRef, callRef_arg6); }, "arg6");

      const CallRef7 callRef_arg7(A7T::V1, A7T::V2, A7T::V3, A7T::V4, A7T::V5, A7T::V6, VF7);
