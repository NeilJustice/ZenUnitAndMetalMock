...
namespace MetalMock
{
   ...
   METALMOCK_VOID7_STATIC(MetalMock::Void7ArgsFunctions, _call_StaticVoid7ArgsFunction, int, int, int, int, int, int, int)
   ...
   const string StaticFunctionSignature =
      "void MetalMock::Void7ArgsFunctions::_call_StaticVoid7ArgsFunction(int, int, int, int, int, int, int)";
   ...
   {
      _metalMock7ArgsTester->CalledWith_ExpectedFunctionCalledOnceWithMatchingArg_DoesNotThrowException();
   }

   TEST(CalledWith_ExpectedFunctionCalledTwiceWithMatchingArgAndOnceWithMistmatchingArg_DoesNotThrowException)
   {
      _metalMock7ArgsTester->CalledWith_ExpectedFunctionCalledTwiceWithMatchingArgAndOnceWithMistmatchingArg_DoesNotThrowException();
   }

   TEST(CalledWith_ExpectedFunctionCalledOnceWithMismatchingArg_ThrowsAnomaly)
   {
      _metalMock7ArgsTester->CalledWith_ExpectedFunctionCalledOnceWithMismatchingArg_ThrowsAnomaly();
   }
