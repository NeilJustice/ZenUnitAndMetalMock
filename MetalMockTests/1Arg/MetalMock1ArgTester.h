...
File.cpp(1))";
  ...
  Failed: ARE_EQUAL(expectedOneArgumentFunctionCall, nextActualOneArgumentFunctionCall, this->_metalMockedFunctionSignature, currentCalledWithAssertionIndexMessage)
