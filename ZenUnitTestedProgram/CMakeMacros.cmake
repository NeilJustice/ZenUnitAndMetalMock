...
macro(EnablePrecompiledHeaders)
   if(UNIX)
      ...
      elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
         if(CMAKE_BUILD_TYPE STREQUAL "" OR CMAKE_BUILD_TYPE STREQUAL "Debug")
            add_custom_target(${PROJECT_NAME}Pch g++ -std=c++14 -Wall -Wextra -Werror -pthread -g
               ${SanitizeAddressArg} -I${CMAKE_SOURCE_DIR} -I/usr/local/include/ZenUnit -x c++-header ${CMAKE_SOURCE_DIR}/${PROJECT_NAME}/pch.h)
         elseif(CMAKE_BUILD_TYPE STREQUAL "Release")
            add_custom_target(${PROJECT_NAME}Pch g++ -std=c++14 -Wall -Wextra -Werror -pthread -O3 -DNDEBUG
               ${SanitizeAddressArg} -I${CMAKE_SOURCE_DIR} -I/usr/local/include/ZenUnit -x c++-header ${CMAKE_SOURCE_DIR}/${PROJECT_NAME}/pch.h)
         elseif(CMAKE_BUILD_TYPE STREQUAL "RelWithDebInfo")
