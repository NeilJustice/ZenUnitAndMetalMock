...
#include "ZenUnitFrameworkTests/Args/Mock/ArgsParserMock.h"
#include "ZenUnitFrameworkTests/Console/Mock/ConsoleMock.h"
#include "ZenUnitFrameworkTests/Random/RandomRunFilter.h"
#include "ZenUnitFrameworkTests/Results/Mock/TestRunResultMock.h"
#include "ZenUnitFrameworkTests/TestRunners/Mock/PreamblePrinterMock.h"
#include "ZenUnitFrameworkTests/TestRunners/Mock/TestClassRunnerRunnerMock.h"
...
namespace ZenUnit
{
      ...
      2u, true, 1)
   {
      ...
      _testRunResultMock->PrintConclusionMock.Expect();
      ...
      ZEN(_testRunResultMock->PrintConclusionMock.CalledOnceWith(
