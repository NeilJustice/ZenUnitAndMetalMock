...
#include "ZenUnitFrameworkTests/Results/Mock/TestClassResultMock.h"
#include "ZenUnitFrameworkTests/Results/Mock/TestFailureNumbererMock.h"
...
namespace ZenUnit
{
   ...
   TEST(ZenUnitEqualizer_ThrowsIfAnyFieldNotEqual)
   {
      ...
      EQUALIZER_THROWS_FOR_FIELD(TestRunResult, _numberOfFailedTestCases, 1);
   }
