...
elseif(MSVC)
   ...
   set(ZenMockIncludeDirectory C:/install/include/ZenMock)
   ...
   if(UNIX)
      ...
      if(CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
         ...
         add_custom_target(${PROJECT_NAME}Pch ${CMAKE_CXX_COMPILER} -std=c++1z -Wall -Wextra -Werror -pthread
            ...
            ${SanitizerArgs} -I${CMAKE_SOURCE_DIR} -I${CMAKE_SOURCE_DIR}/ZenUnit -x c++-header ${CMAKE_SOURCE_DIR}/${PROJECT_NAME}/pch.h)
