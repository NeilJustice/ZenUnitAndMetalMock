...
#include "ZenUnitLibraryTests/Results/ZenMock/TestResultMock.h"
#include "ZenUnitUtilsAndAssertionTests/Utils/Iteration/ZenMock/MemberForEacherMock.h"
...
namespace ZenUnit
{
   ...
   TEST7X7(PrintConclusionLines_PositiveTotalNumberOfTests_PrintsSuccesOrFailureAndElapsedMilliseconds,
      ...
      "+SUCCESS+", Color::Green, size_t(0), size_t(1), "All 1 test succeeded", 0, "milliseconds",
      "+SUCCESS+", Color::Green, size_t(0), size_t(2), "All 2 tests succeeded", 1, "millisecond",
      "+SUCCESS+", Color::Green, size_t(0), size_t(3), "All 3 tests succeeded", 2, "milliseconds",
      "+SUCCESS+", Color::Green, size_t(0), size_t(3), "All 3 tests succeeded", 2, "milliseconds",
