...
#include "ZenUnitLibraryTests/Args/ZenMock/ArgsParserMock.h"
#include "ZenUnitLibraryTests/Console/ZenMock/ConsoleMock.h"
#include "ZenUnitLibraryTests/Random/RandomRunFilter.h"
#include "ZenUnitLibraryTests/Results/ZenMock/TestRunResultMock.h"
#include "ZenUnitLibraryTests/TestRunners/ZenMock/PreamblePrinterMock.h"
#include "ZenUnitLibraryTests/TestRunners/ZenMock/TestClassRunnerRunnerMock.h"
...
namespace ZenUnit
{
      ...
      2u, true, 1)
   {
      ...
      const string startTime = _preamblePrinterMock->PrintPreambleLinesAndGetStartTimeMock.ReturnRandom();
