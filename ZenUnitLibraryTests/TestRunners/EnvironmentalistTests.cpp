...
namespace ZenUnit
{
   ...
   AFACT(GetCurrentMachineName_ReturnsEitherCallToGetLinuxOrGetWindowsMachineName)
   ...
   {
      const filesystem::path currentDirectoryPath = current_path_ZenMockObject.ReturnRandom();
      //
...
#elif defined _WIN32
   TEST(GetCurrentMachineName_ReturnsEitherCallToGetLinuxOrGetWindowsMachineName)
   {
