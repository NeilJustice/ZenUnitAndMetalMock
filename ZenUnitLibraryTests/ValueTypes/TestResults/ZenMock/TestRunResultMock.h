...
public:
   ...
   ZENMOCK_VOID4_CONST(PrintConclusionLines, const string&, size_t, const string&, const ZenUnitArgs&)
   ZENMOCK_NONVOID1_CONST(int, DetermineZenUnitExitCode, const ZenUnitArgs&)
