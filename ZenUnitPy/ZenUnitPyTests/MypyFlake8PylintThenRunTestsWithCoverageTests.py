...
from ZenUnitPy import MypyFlake8PylintThenRunTestsWithCoverage, Process, Python, UnitTester
...
class RunZenUnitPyTestsWithCoverageAndLintingTests(unittest.TestCase):
   ...
   @patch('ZenUnitPy.Python.run_mypy', spec_set=True)
   @patch('ZenUnitPy.Python.run_flake8', spec_set=True)
   @patch('ZenUnitPy.Python.run_pylint_on_all_files_in_parallel', spec_set=True)
