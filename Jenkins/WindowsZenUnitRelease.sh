...
python ../ZenUnitPy/ZenUnitPy/BuildAndInstall.py "Visual Studio 14 2015 Win64" Release ZenUnitTestedProgram StaticLibrary.Test "" -DCMAKE_INSTALL_PREFIX=. Install
