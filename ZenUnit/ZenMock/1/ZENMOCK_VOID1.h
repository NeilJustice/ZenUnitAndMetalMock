...
#define ZENMOCK_VOID1(functionName, arg1Type, ...) \
        ZENMOCK_VOID1_DEFINED(functionName, arg1Type, virtual,      ,        , override, __VA_ARGS__)

#define ZENMOCK_VOID1_CONST(functionName, arg1Type, ...) \
        ZENMOCK_VOID1_DEFINED(functionName, arg1Type, virtual, const, mutable, override, __VA_ARGS__)
...
// Implementation
#define ZENMOCK_VOID1_DEFINED(functionName, arg1Type, virtualness, constness, mutableness, overrideness, ...) \
virtualness void functionName(arg1Type arg) constness overrideness \
{ \
   functionName##Mock##__VA_ARGS__.PrivateZenMock(arg); \
} \
...
namespace ZenMock
{
   ...
   public:
      ...
      {
         functionMocker->PrivateZenMock(arg1);
      }
   };
}
