...
ZenUnit is a C++ single-header unit testing framework designed for assertion exactness, error message clarity, and long-term test code readability while unit testing safety-critical C++ software. ZenUnit's signature feature is its convenient syntax for writing value-parameterized and type-parameterized unit tests.
