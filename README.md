...
<h4 align="center">ZenMock is a single-header C++ mocking framework powered by ZenUnit that provides a high-readability arrange-act-assert syntax for confirming the correctness of function call arguments and return values to and from virtual, non-virtual, static, and free functions.</h4>
