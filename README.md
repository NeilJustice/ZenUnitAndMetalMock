...
|`ZenUnit::RandomPair<FirstType, SecondType>`|Returns a random `std::pair<FirstType, SecondType>` with `pair.first` generated by `ZenUnit::Random<FirstType>()` and `pair.second` generated by `ZenUnit::Random<SecondType>()`.
