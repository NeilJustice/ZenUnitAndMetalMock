...
namespace ZenUnit
{
   ...
   SPEC(ExpectedAndActualAddressesNotEqual_DoesNotThrow)
   SPEC(ExpectedAndActualAddressesEqual_Throws)
   SPEC(ExpectedAndActualAddressesEqual_Throws_MessagesTestCase)
   SPECEND
