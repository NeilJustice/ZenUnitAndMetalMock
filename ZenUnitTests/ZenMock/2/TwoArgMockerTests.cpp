...
namespace ZenMock
{
   ...
   using MockerType = TwoArgMocker<int, int, ExceptionThrowerMock>;
   ...
   TEST(ZenMockIt_ExpectedFalse_Throws)
   {
      ...
      THROWS(_mocker->ZenMockIt(1, 2), UnexpectedCallException,
         UnexpectedCallException::MakeWhat(Test::Signature, 1, 2));
   }
