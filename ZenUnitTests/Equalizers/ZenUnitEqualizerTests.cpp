...
namespace ZenUnit
{
   ...
   SPEC(TemplateZenUnitEqualizer_ValuesAreEqualityOperatorEqual_DoesNotThrow)
   SPEC(TemplateZenUnitEqualizer_ValuesNotEqualityOperatorEqual_Throws)
   SPEC(TemplateTwoTypeZenUnitEqualizer_ValuesAreEqualityOperatorEqual_DoesNotThrow)
   SPEC(TemplateTwoTypeZenUnitEqualizer_ValuesNotEqualityOperatorEqual_Throws)
   SPEC(ConstCharPointer_ConstCharPointer_Equal_DoesNotThrow)
   SPEC(ConstCharPointer_ConstCharPointer_NotEqual_Throws)
   SPEC(CharPointer_CharPointer_Equal_DoesNotThrow)
   SPEC(CharPointer_CharPointer_NotEqual_Throws)
   SPEC(ConstCharPointer_CharPointer_Equal_DoesNotThrow)
   SPEC(ConstCharPointer_CharPointer_NotEqual_Throws)
   SPEC(CharPointer_ConstCharPointer_Equal_DoesNotThrow)
   SPEC(CharPointer_ConstCharPointer_NotEqual_Throws)
   SPEC(ConstCharPointer_StdString_Equal_DoesNotThrow)
   SPEC(ConstCharPointer_StdString_NotEqual_Throws)
   SPEC(StdString_ConstCharPointer_Equal_DoesNotThrow)
   SPEC(StdString_ConstCharPointer_NotEqual_Throws)
   SPEC(Double_Double_ExactlyEqual_DoesNotThrow)
   SPEC(Double_Double_NotExactlyEqual_Throws)
   SPEC(Double_Float_ExactlyEqual_DoesNotThrow)
   SPEC(Double_Float_NotExactlyEqual_Throws)
   SPEC(Int_SizeT_ThrowsIfIntNegative_OtherwiseCallsAssertEqualSizeTSizeT)
   SPEC(Int_Unsigned_ThrowsIfIntNegative_OtherwiseCallsAssertEqualUnsignedUnsigned)
   SPECEND
