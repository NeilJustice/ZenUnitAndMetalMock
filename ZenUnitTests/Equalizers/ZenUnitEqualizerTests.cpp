...
namespace ZenUnit
{
   ...
   FACT(TemplateZenUnitEqualizer_ValuesAreEqualityOperatorEqual_DoesNotThrow)
   FACT(TemplateZenUnitEqualizer_ValuesNotEqualityOperatorEqual_Throws)
   FACT(TemplateTwoTypeZenUnitEqualizer_ValuesAreEqualityOperatorEqual_DoesNotThrow)
   FACT(TemplateTwoTypeZenUnitEqualizer_ValuesNotEqualityOperatorEqual_Throws)
   FACT(ConstCharPointer_ConstCharPointer_Equal_DoesNotThrow)
   FACT(ConstCharPointer_ConstCharPointer_NotEqual_Throws)
   FACT(CharPointer_CharPointer_Equal_DoesNotThrow)
   FACT(CharPointer_CharPointer_NotEqual_Throws)
   FACT(ConstCharPointer_CharPointer_Equal_DoesNotThrow)
   FACT(ConstCharPointer_CharPointer_NotEqual_Throws)
   FACT(CharPointer_ConstCharPointer_Equal_DoesNotThrow)
   FACT(CharPointer_ConstCharPointer_NotEqual_Throws)
   FACT(ConstCharPointer_StdString_Equal_DoesNotThrow)
   FACT(ConstCharPointer_StdString_NotEqual_Throws)
   FACT(StdString_ConstCharPointer_Equal_DoesNotThrow)
   FACT(StdString_ConstCharPointer_NotEqual_Throws)
   FACT(Double_Double_ExactlyEqual_DoesNotThrow)
   FACT(Double_Double_NotExactlyEqual_Throws)
   FACT(Double_Float_ExactlyEqual_DoesNotThrow)
