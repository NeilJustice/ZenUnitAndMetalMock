...
namespace ZenUnit
{
   ...
   {
      THROWS(DOES_NOT_THROW([] { throw runtime_error("what text"); }()), Anomaly, R"(
...
File.cpp(1))");
   ...
   TEST(LambdaCallThrows_Throws_MessagesTestCase)
   {
      ...
      THROWS(DOES_NOT_THROW([] { throw runtime_error(""); }(), MessageA, MessageB), Anomaly, R"(
...
File.cpp(1))");
   ...
   {
      THROWS(DOES_NOT_THROW(Throw()), Anomaly, R"(
