...
FilePath(1))")
   ...
   TEST(ZENWrapped_ReturnsExpectedAnomaly)
   {
      ...
      zenWrappedAnomaly.assertExpression = "ARE_EQUAL(expectedArgument, oneArgumentCalls[0].firstArgument, this->ZenMockedFunctionSignature)";
 ...
 Because: ARE_EQUAL(expectedArgument, oneArgumentCalls[0].firstArgument, this->ZenMockedFunctionSignature) failed
Expected: "expected"
  Actual: "actual"
