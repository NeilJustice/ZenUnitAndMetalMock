...
namespace ZenUnit
{
   ...
   FACT(ToString_Arithmetic_ReturnsResultOfStdToString)
   FACT(ToString_Enum_ReturnsStdToStringOnTheValue)
   FACT(ToString_EnumClass_ReturnsStdToStringOnTheValue)
   FACT(ToString_Nullptr_ReturnsNullptrInBrackets)
   FACT(ToString_NonArithmeticType_ReturnsInsertionOperatorValue)
   FACT(ToString_Pointer_ReturnsNullptrIfNullptrOtherwiseMemoryAddress)
   FACT(ToString_UniquePtr_ReturnsPointeeAddress)
   FACT(ToString_UniquePtrWithCustomDeleter_ReturnsPointeeAddress)
   FACT(ToString_SharedPtr_ReturnsPointeeAddress)
   ...
   FACT(ToString_CharPointer_ReturnsNullptrIfNullptrOtherwiseQuotedString)
   FACT(ToString_ConstCharPointer_ReturnsNullptrIfNullptrOtherwiseQuotedString)
   FACT(ToString_Char_ReturnsQuotedChar)
   FACT(ToString_Bool_ReturnsBoolAlpha)
   FACT(ToString_Pair_ReturnsLeftParenFirstValueCommaSecondValueRightParen)
   FACT(ToString_TypeHasNeitherOStreamInsertionOperatorOrZenUnitPrint_ReturnsRTTINameInBrackets)
   FACT(ToString_TypeHasOStreamInsertionOperatorAndNotZenUnitPrint_ReturnsOStreamLeftShiftResult)
