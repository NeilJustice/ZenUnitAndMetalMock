...
namespace ZenUnit
{
   ...
   TEST2X2(SupportsColor_ReturnsTrueIfStdoutIsATTY,
      ...
      1, true)
   {
      ZENMOCK_NONVOID1_GLOBAL_FREE(int, fileno, FILE*);
      ZENMOCK_NONVOID1_GLOBAL_FREE(int, isatty, int);
   ...
   {
      ZENMOCK_NONVOID1_GLOBAL_FREE(HANDLE, GetStdHandle, DWORD);
      ZENMOCK_NONVOID2_GLOBAL_FREE(BOOL, SetConsoleTextAttribute, HANDLE, WORD);
