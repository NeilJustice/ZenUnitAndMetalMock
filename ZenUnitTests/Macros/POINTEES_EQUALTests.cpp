...
FACT(ExpectedPointerNullptr_ActualPointerNullptr_DoesNotThrow)
FACT(ExpectedPointerNullptr_ActualPointerNotNullptr_Throws)
FACT(ExpectedPointerNotNullptr_ActualPointerNullptr_Throws)
FACT(ExpectedPointerNotNull_ActualPointerNotNull_PointeesNotEqual_Throws)
FACT(ExpectedPointerNotNull_ActualPointerNotNull_PointeesNotEqual_Throws_MessagesTestCase)
