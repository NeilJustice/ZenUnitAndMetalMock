...
SPEC(ExpectedPointerNullptr_ActualPointerNullptr_DoesNotThrow)
SPEC(ExpectedPointerNullptr_ActualPointerNotNullptr_Throws)
SPEC(ExpectedPointerNotNullptr_ActualPointerNullptr_Throws)
SPEC(ExpectedPointerNotNull_ActualPointerNotNull_PointeesNotEqual_Throws)
SPEC(ExpectedPointerNotNull_ActualPointerNotNull_PointeesNotEqual_Throws_MessagesTestCase)
SPEC(ExpectedPointerNotNull_ActualPointerNotNull_PointeesNotEqual_UserTypes_Throws)
SPEC(ExpectedPointerNotNull_ActualPointerNotNull_PointeesEqual_DoesNotThrow)
SPEC(ExpectedPointerNotNull_ActualPointerNotNull_PointeesEqual_UserTypes_DoesNotThrow)
SPECEND
