...
struct TestMock : public Zen::Mock<Test>
{
   ...
   ZENMOCK_VOID2_CONST(OptionallyWritePostTestNameMessage, const Console*, bool)
   ...
   ZENMOCK_VOID3_CONST(OptionallyWritePostTestCompletionMessage, const Console*, const TestResult&, bool)
};
