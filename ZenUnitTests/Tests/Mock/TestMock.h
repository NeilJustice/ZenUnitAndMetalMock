...
struct TestMock : public Zen::Mock<Test>
{
   ...
   ZENMOCK_VOID2_CONST(NonLaconicWritePostTestNameMessage, const Console*, PrintMode)
   ...
   ZENMOCK_VOID3_CONST(NonLaconicWritePostTestCompletionMessage, const Console*, const TestResult&, PrintMode)
};
