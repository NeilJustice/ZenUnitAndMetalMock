...
TEST(CallAllMacros)
{
   ...
   // Equalizers
   ZENUNIT_EQUALIZER_TEST_SETUP(Struct);
   ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Struct, firstField, 1);
   ZENUNIT_EQUALIZER_THROWS_WHEN_FIELD_NOT_EQUAL(Struct, secondField, 'A');
}
