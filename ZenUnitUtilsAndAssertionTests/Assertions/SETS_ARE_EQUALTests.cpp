...
"Expected: " + _expectedIntSetTypeName + " (size 1):",
"{",
"   1",
"}",
"  Actual: " + _expectedIntSetTypeName + " (size 0):",
"{",
"}",
...
"   1",
"}",
"  Actual: " + _expectedIntSetTypeName + " (size 1):",
"{",
"   2",
"}",
...
"  Failed: SETS_ARE_EQUAL(expectedSet, actualSet)",
"Expected: " + _expectedUserTypeSetTypeName + " (size 1):",
"{",
"   UserType@1",
"}",
"  Actual: " + _expectedUserTypeSetTypeName + " (size 1):",
"{",
"   UserType@2",
"}",
" Because: CONTAINS_ELEMENT(expectedElement, actualSet) failed",
